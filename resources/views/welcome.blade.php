                        ...
                        <div class="row justify-content-around">
                            <div class="col-9">
                                ...
                                <div class="tasks">
                                    ...
                                    <div class="task-item d-flex justify-content-between">
                                        <div class="task-descr">
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio, earum dolor perferendis fugit assumenda maxime.
                                        </div>
                                        <div class="task-actions align-self-center">
                                            <i class="fa fa-edit fa-lg green"></i>
                                            <i class="fa fa-trash fa-lg red"></i>
                                    ...
                                    <div class="task-item d-flex justify-content-between">
                                        <div class="task-descr">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Facilis dolorem libero suscipit aspernatur minus. Nostrum quae nemo asperiores possimus cupiditate.
                                        </div>
                                        <div class="task-actions align-self-center">
                                            <i class="fa fa-edit fa-lg green"></i>
                                            <i class="fa fa-trash fa-lg red"></i>
